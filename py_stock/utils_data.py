...
try:
  from utils_stock import code2name,clensing, get
except:
  sys.path.append("..")
  from py.utils_stock import code2name,clensing, get
...
def get_stock(col,name, n=10, download=True):
  """
...
if __name__ == "__main__":
  ...
  if 0: #業界別の企業一覧検索
    ...
    get_stock(col=col,name =name,n=20)
